...
import { MapPin, CreditCard, ShoppingCart, AlertCircle, Check, Trash2 } from 'lucide-react';
...
export default function CinemaCart() {
  ...
  const { items: cartItems, removeItem, clearCart, getTotalAmount, getRoomNumber } = useCartStore();
  ...
  const handleAddressSelect = (feature: AddressFeature) => {
    const { label, postcode, city, housenumber, street: streetName } = feature.properties;
      ...
      <div className="min-h-screen bg-gray-50 py-12">
        <div className="container mx-auto px-4">
          <div className="bg-white rounded-lg shadow-lg p-6 text-center">
            <h2 className="text-xl font-semibold mb-4">Vous devez être connecté pour accéder au panier</h2>

...
import { Calendar, MapPin, Clock, Edit, Trash2, Repeat, AlertCircle } from 'lucide-react';
      ...
      <div className="min-h-screen bg-gray-50 py-12">
        <div className="container mx-auto px-4">
          <div className="bg-white rounded-lg shadow-lg p-6 text-center">
            <h2 className="text-xl font-semibold mb-4">Vous devez être connecté pour voir vos événements</h2>
    ...
    <div className="min-h-screen bg-gray-50 py-12">
      <div className="container mx-auto px-4">
        ...
        {loading ? (
          ...
          <div className="bg-white rounded-lg shadow-lg p-6 text-center">
            <h2 className="text-xl font-semibold mb-4">Vous n'avez pas encore créé d'événements</h2>
        ...
        >
          <Modal.Header>
            <div className="text-xl font-semibold">Confirmer la suppression</div>
          </Modal.Header>
          <Modal.Body>

 ...
 */
export async function addToFavorites(userId: string, eventId: string): Promise<string> {
  try {
    const favorite = {
      userId,
      eventId,
 ...
 */
export async function removeFromFavorites(userId: string, eventId: string): Promise<void> {
  try {
